...
public class EnvelopeParameter extends EventProcessorBindingParams {

    private String wkt_string;
    private String epsg_code;


    public EnvelopeParameter(DataProcessorInvocation graph, String wkt_String, String epsg_code) {
        super(graph);
