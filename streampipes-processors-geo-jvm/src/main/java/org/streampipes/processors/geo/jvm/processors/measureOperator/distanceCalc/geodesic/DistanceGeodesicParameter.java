...
public class DistanceGeodesicParameter extends EventProcessorBindingParams {
    ...
    public DistanceGeodesicParameter(DataProcessorInvocation graph, String geom_1, String epsg_geom_1, String geom_2, String epsg_geom_2, Integer unit, Integer decimalPosition) {
        super(graph);
        this.geom_1 = geom_1;
