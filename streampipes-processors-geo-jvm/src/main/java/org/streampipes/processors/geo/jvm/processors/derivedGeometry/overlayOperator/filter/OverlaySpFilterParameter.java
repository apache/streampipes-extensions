...
public class OverlaySpFilterParameter extends EventProcessorBindingParams {
    ...
    public OverlaySpFilterParameter(DataProcessorInvocation graph, String geom_1, String epsg_geom_1, String geom_2, String epsg_geom_2, Integer type, Boolean vsChecker) {
        super(graph);
        this.geom_1 = geom_1;
