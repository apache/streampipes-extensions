...
public class OverlaySpEnricherController extends StandaloneEventProcessingDeclarer<OverlaySpEnricherParameter> {
    ...
    @Override
    public ConfiguredEventProcessor<OverlaySpEnricherParameter> onInvocation(DataProcessorInvocation graph, ProcessingElementParameterExtractor extractor) {
        ...
        OverlaySpEnricherParameter params = new OverlaySpEnricherParameter(graph,geom1, epsg_geom1, geom2, epsg_geom2, overlayType, vsChecker);

        return new ConfiguredEventProcessor<>(params, OverlaySpEnricher::new);
    }
}
